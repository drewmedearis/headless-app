          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <p className="text-lg text-cursor-text-secondary mb-8 leading-relaxed">
                Get access to our full investor presentation. See our traction,
                unit economics, and the $100K raise opportunity.
              </p>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-cursor-text-secondary text-sm">Insane unit economics via agent-driven acquisition</p>
                  </div>
                </div>
              </div>
            ...
            <div className="card p-8">
              ...
              {submitStatus === "success" ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    <label className="block text-sm text-cursor-text-secondary mb-2">
                      First Check Investment Size <span className="text-red-400">*</span>
                    </label>
